...
import { UsuariosServices } from '../services/UsuarioServices'
...
class UsuariosControllers {
    ...
    async enderecoUsuarios(req: Request, res: Response) {
        const { rua, telefone, bairro, cep, numero, cidade, complemento } = req.body
        const enviarDadosServices = new UsuariosServices()
        const resposta = await enviarDadosServices.enderecoUsuarios({
            rua,
            telefone,
            bairro,
            cep,
